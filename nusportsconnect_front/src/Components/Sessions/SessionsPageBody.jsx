            ...
            <div className='session-left'>
                <div className='event-header'>
                    ...
                    <div className='event-host-details'>
                        <h3 className='event-subtitle'>Hosted by: {sessionInfo.host.fName + " " + sessionInfo.host.lName}</h3>
                ...
                <div className='event-description-box'>
                        <div className='event-description'>
                            <div className='event-description-desc'>
                                ...
                                <p className='event-description-body'>{sessionInfo.description}</p>                 
                            </div>
                            <div className='event-description-desc'>
                                <p className='event-description-header'>Minimum stars</p>
                                {minStars.length === 0 ? <p>No Minimum Stars!</p> : minStars.map(() => {
